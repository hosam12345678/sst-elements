...
# ============================================================================
num_compute_nodes = 1  # Multiple compute nodes
num_memory_servers = 2  # Multiple memory servers
btree_fanout = 4

# Workload Configuration
operations_per_second = 20  # Moderate rate
simulation_duration_us = 1000000  # 1000ms
read_ratio = 0.5  # 100% reads (searches only, NO inserts)
key_range = 64  # Keys 0-63
